...
def evaluate_metric(directory, model, tokenizer):
    ...
    print(f"Eval saved to {os.path.join(directory, "conceptual_level_by_activations.json")}")
...
if __name__ == "__main__":
    ...
    directory = "data/gemma-2-2b-gemmascope-res-16k"
    for subdir in os.listdir(directory):
        evaluate_metric(os.path.join(directory, subdir), model, tokenizer)
